...
class SettingsDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        self.spin_grade_threshold = QSpinBox()
        self.spin_grade_threshold.setRange(0, 5)
        self.spin_grade_threshold.setSuffix(" 级")
        ...
        alarm_layout.addRow("等级报警阈值 (>", self.spin_grade_threshold)
    ...
    def _load_settings(self):
        ...
        self.spin_grade_threshold.setValue(int(settings.get("alarm_grade_threshold", 1)))
    ...
    def _on_ok(self):
        ...
        settings.set("alarm_grade_threshold", self.spin_grade_threshold.value())
